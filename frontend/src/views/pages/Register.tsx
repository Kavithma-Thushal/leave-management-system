...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-darkBlue px-4">
            <div
                className="bg-white bg-opacity-10 backdrop-blur-lg shadow-lg rounded-2xl p-12 w-[550px] border border-neonBlue border-opacity-50 pt-5 pb-8 mt-6">
                <h2 className="text-4xl font-bold text-neonBlue drop-shadow-lg text-center mb-8 tracking-wide">REGISTER</h2>
                <form onSubmit={register} className="space-y-8">
                    ...
                    <div className="flex justify-center">
                        <button type="submit"
                                className="bg-neonBlue text-darkBlue py-3 rounded-lg font-semibold shadow-lg hover:scale-105 transition duration-300 px-6">REGISTER
                        </button>
                    </div>
                </form>
            </div>
